...
public class Http2Request extends Http2ConnectionHandler implements Http2FrameListener {
    protected Http2Request(Http2ConnectionDecoder decoder, Http2ConnectionEncoder encoder, Http2Settings initialSettings) {
        super(decoder, encoder, initialSettings);
    }

    public void rstStream(ChannelHandlerContext ctx, int streamId) {
        frameWriter().writeRstStream(ctx, streamId, 1, ctx.newPromise());
    }
    @Override
